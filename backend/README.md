...
## Project Structure
    ...
    ├── cookieclickers_29907  # Django project configurations
...
1. Clone this repo and `cd cookieclickers_29907`
...
2. Clone this repo and `cd cookieclickers_29907`
